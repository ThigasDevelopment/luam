...
export const MTA_DOCS_43: ApiDocumentationCatalog = {
    setRadarAreaSize: {
        summary: 'This function changes the size of an existing radararea|radar area.',
        parameters: [
    ...
    setRainLevel: {
        summary: 'This function sets the rain level to any weather available in GTA. Use resetRainLevel to\nundo the changes.',
        parameters: [
            { name: 'level', isOptional: false, isVariadic: false, summary: 'A floating point number representing the rain level. 1 represents the maximum rain level usually available in GTA, but higher values are accepted. Note The level value is clamped between 0.0 and 10.0 to avoid gameplay issues.' },
        ],
    ...
    setRuleValue: {
        ...
        parameters: [
            ...
            { name: 'value', isOptional: false, isVariadic: false, summary: 'The value you wish to set for the rule' },
        ],
    ...
    setSearchLightEndRadius: {
        summary: 'This function sets the end radius of a Element/Searchlight|searchlight element.',
        parameters: [
    ...
    setSearchLightStartPosition: {
        summary: 'This function sets the start position of a Element/Searchlight|searchlight element.',
        parameters: [
            { name: 'theSearchLight', isOptional: false, isVariadic: false, summary: ': the searchlight to modify the property of.' },
    ...
    setSearchLightStartRadius: {
        summary: 'This function sets the start radius of a Element/Searchlight|searchlight element.',
        parameters: [
            { name: 'theSearchlight', isOptional: false, isVariadic: false, summary: '' },
    ...
    setServerPassword: {
        summary: 'This function changes the password required to join the server to the given string.',
        parameters: [
    ...
    setSoundEffectEnabled: {
        ...
        parameters: [
            { name: 'theSound_thePlayer', isOptional: false, isVariadic: false, summary: '' },
    ...
    setSoundEffectParameter: {
        ...
        parameters: [
            ...
            { name: 'effectParam', isOptional: false, isVariadic: false, summary: ': The parameter #Effects Parameters|name.' },
            { name: 'paramValue', isOptional: false, isVariadic: false, summary: ': The parameter #Effects Parameters|value.' },
        ],
    ...
    setSoundLooped: {
        summary: '',
        parameters: [
            { name: 'theSound', isOptional: false, isVariadic: false, summary: 'The sound element to set the loop. bool A boolean representing whether the sound will be looped.' },
    ...
    setSoundPan: {
        ...
        parameters: [
            ...
            { name: 'pan', isOptional: false, isVariadic: false, summary: 'A float|floating point number representing the desired pan level. Range is from -1.0 (left) to 1.0 (right)' },
        ],
    ...
    setSoundPanningEnabled: {
        summary: 'This function toggles the panning of a sound (hearing it closer to the left or right side\nof the speakers due to the camera position). By default a sound has its panning enabled.',
        parameters: [
    ...
    setSoundPaused: {
        summary: 'This function is used to either pause or unpause the playback of the specified sound\nelement.\nUse a player element to control a players voice with this function.',
        parameters: [
    ...
    setSoundPosition: {
        ...
        returns: 'returns true if the sound elements seek position was successfully changed, false otherwise.',
    ...
    setSoundProperties: {
        ...
        parameters: [
            ...
            { name: 'fSampleRate', isOptional: false, isVariadic: false, summary: 'a float that defines the new sounds http://en.wikipedia.org/wiki/Sampling_rate sample rate' },
