...
export const MTA_DOCS_46: ApiDocumentationCatalog = {
    setPedWalkingStyle: {
        summary: 'Sets the walking style of a ped. A walking style consists of a set of animations that are used for walking, running etc.',
        parameters: [
            { name: 'thePed', isOptional: false, isVariadic: false, summary: 'the ped whose walking style to change.' },
            { name: 'style', isOptional: false, isVariadic: false, summary: 'the walking style to set.' },
        ],
    ...
    setPickupType: {
        summary: 'This function allows changing the type of a pickup to a Weapon, Armour or Health pickup, and allows you to set the health points **or** the weapon and ammo that the pickup will give.',
        parameters: [
            { name: 'thePickup', isOptional: false, isVariadic: false, summary: 'The pickup which you wish to change the settings of' },
            { name: 'theType', isOptional: false, isVariadic: false, summary: 'An integer representing the type of pickup. You can choose from:' },
    ...
    setPlayerHudComponentProperty: {
        summary: 'This function allows for modifying HUD properties, such as text or bar color, position, size, and more.',
        parameters: [
            { name: 'component', isOptional: false, isVariadic: false, summary: 'The component you wish to modify. See HUD Components.' },
            { name: 'property', isOptional: false, isVariadic: false, summary: 'The name of the property you want to modify. See HUD Properties.' },
            { name: 'value', isOptional: false, isVariadic: false, summary: 'The value you want to set.' },
        ],
        returns: 'Returns **true** if the property was successfully modified, **false** otherwise.',
        wiki: 'https://wiki.multitheftauto.com/wiki/SetPlayerHudComponentProperty',
    },
    setPlayerHudComponentVisible: {
        summary: 'This function will show or hide a part of the player\'s HUD.',
        parameters: [
            ...
            { name: 'component', isOptional: false, isVariadic: false, summary: 'The component you wish to show or hide. Valid values are:' },
    ...
    setPlayerMoney: {
        summary: 'Sets a player\'s money to a certain value, regardless of current player money. It should be noted that setting negative values does not work and in fact gives the player large amounts of money.',
        parameters: [
            { name: 'thePlayer', isOptional: false, isVariadic: false, summary: 'Which player to set the money of.' },
            { name: 'amount', isOptional: false, isVariadic: false, summary: 'A whole integer specifying the new amount of money the local player will have.' },
    ...
    setPlayerMuted: {
        summary: 'Use this function to mute or unmute the player. Muted player won\'t be able to say anything in chat.',
        parameters: [
    ...
    setPlayerName: {
        summary: 'This function changes the specified player\'s name. Note that any change made to a players name with this function is not saved in their settings so the name change only lasts till they disconnect.',
        parameters: [
    ...
    setPlayerNametagColor: {
        ...
        parameters: [
            ...
            { name: 'b', isOptional: false, isVariadic: false, summary: 'The amount of blue you want in the mixture of RGB (0-255 is valid)' },
        ],
        returns: '<!-- Make this descriptive. Explain what cases will return false. If you\'re unsure, add a tag to it so we can check --> Returns *true* if the function was successful, *false* otherwise.',
        wiki: 'https://wiki.multitheftauto.com/wiki/SetPlayerNametagColor',
    },
    setPlayerNametagShowing: {
        summary: 'This function allows you to set whether a player\'s nametag visibility both clientside and serverside\n\nUse this to define whether the player\'s name tag is visible or invisible.',
        parameters: [
    ...
    setPlayerNametagText: {
        ...
        returns: '<!-- Make this descriptive. Explain what cases will return false. If you\'re unsure, add a tag to it so we can check --> Returns *true* if successful, *false* otherwise.',
    ...
    setPlayerTeam: {
        summary: 'This function adds a player to an existing team. The player will automatically be removed from his current team if he\'s on one.',
        parameters: [
    ...
    setPlayerWantedLevel: {
        summary: 'This function is used to set a player\'s wanted level. The wanted level is indicated by the amount of stars a player has on the GTA HUD.',
        parameters: [
    ...
    setRadarAreaColor: {
        ...
        parameters: [
            ...
            { name: 'a', isOptional: false, isVariadic: false, summary: 'an integer representing the color\'s alpha (0 for transparent, 255 for opaque)' },
        ],
    ...
    setRadarAreaSize: {
        summary: 'This function changes the size of an existing radar area.',
        parameters: [
            { name: 'theRadararea', isOptional: false, isVariadic: false, summary: 'the radararea element whose size is to be changed.' },
            { name: 'x', isOptional: false, isVariadic: false, summary: 'the x length of the radar area.' },
            { name: 'y', isOptional: false, isVariadic: false, summary: 'the y length of the radar area.' },
        ],
    ...
    setRadioChannel: {
        summary: 'This function sets the heard radio channel, even while not in a vehicle.',
        parameters: [
            { name: 'ID', isOptional: false, isVariadic: false, summary: 'The ID of the radio station you want to play.' },
        ],
