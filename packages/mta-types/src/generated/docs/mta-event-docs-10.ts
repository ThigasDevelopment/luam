...
export const MTA_EVENT_DOCS_10: EventDocumentationCatalog = {
    onResourceStateChange: {
        summary: '<!-- Change version when https://buildinfo.multitheftauto.com will be updated -->\n\nThis event is triggered when a resource\'s state is changed.\nThis event is an extended version of onResourceLoadStateChange',
        parameters: [
        ...
        cancel: '',
        wiki: 'https://wiki.multitheftauto.com/wiki/OnResourceStateChange',
    },
    onResourceStop: {
    ...
    onShutdown: {
        summary: 'This event is triggered when the server is about to be stopped using the server console or the shutdown function.',
        parameters: [
            { name: 'theResource', isOptional: false, isVariadic: false, summary: 'The resource that stops the server using the shutdown function. If the server is being stopped from the console, the **resource** is set to **nil**.' },
            { name: 'reason', isOptional: false, isVariadic: false, summary: 'The reason for stopping the server (if provided).' },
        ],
        source: 'The source of this event is **root**.',
        cancel: 'This event cannot be canceled.',
        wiki: 'https://wiki.multitheftauto.com/wiki/OnShutdown',
    },
    onTrailerAttach: {
