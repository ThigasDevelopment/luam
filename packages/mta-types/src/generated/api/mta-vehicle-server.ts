...
export const MTA_VEHICLE_SERVER: ApiCatalog = {
    ...
    getVehicleIdleRespawnDelay: fn([named('Vehicle')], NUMBER, 1),
    getVehicleRespawnDelay: fn([named('Vehicle')], NUMBER, 1),
    getVehicleRespawnPosition: fn([named('Vehicle')], tupleOf([NUMBER, NUMBER, NUMBER]), 1),
    getVehicleRespawnRotation: fn([named('Vehicle')], tupleOf([NUMBER, NUMBER, NUMBER]), 1),
    getVehiclesOfType: fn([NUMBER], TABLE, 1),
    isVehicleRespawnable: fn([named('Vehicle')], BOOLEAN, 1),
