...
export const MTA_CAMERA_CLIENT: ApiCatalog = {
    ...
    getCameraDrunkLevel: fn([], NUMBER, 0),
    ...
    resetShakeCamera: fn([], BOOLEAN, 0),
    setCameraClip: fn([BOOLEAN, BOOLEAN], BOOLEAN, 0),
    setCameraDrunkLevel: fn([NUMBER], BOOLEAN, 1),
    setCameraFieldOfView: fn([STRING, NUMBER, BOOLEAN], BOOLEAN, 2),
    ...
    shakeCamera: fn([NUMBER, NUMBER, NUMBER, NUMBER], BOOLEAN, 1),
};
